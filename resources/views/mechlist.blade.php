...
<html lang="en">
  ...
  <body>
      <div class="container mt-5">
          <h3 class="text-center"> Mechanics  Near By Location </h3>
        <div class="row mt-4">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 m-auto">
                    <div class="card shadow p-3">
                        {{-- <div class="card-image border" style="height:228px;">
                            ...
                            <h5 class="card-title float-left pt-2"> {{ $mechanics->name }}  <small class="text-right float-right"></small></h5>
                        <p> {{ $mechanics->phone }} <a href=" ">Call</a></p>
                    </div>
                </div>
            @endforeach
        </div>
